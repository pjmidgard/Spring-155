                            ...
                            if D==1:
                                ...
                                if i==1:
                                    ...
                                    while Extract1!=1:
                                            ...
                                            Equal_info_between_of_the_cirlce_of_the_file2=format(N_5,'04b')
                                            Equal_info_between_of_the_cirlce_of_the_file3=format(Times_10,'04b')
                                            Add_N=format(Times_11,'01b')
                                ...
                                if i==2:
                                    ...
                                    if C==1:
                                        ...
                                        if   Circle_times2==0 and len(sda)>5*8:
                                                ...
                                                if len(sda)>5*8:
                                                    Equal_info_between_of_the_cirlce_of_the_file=Equal_info_between_of_the_cirlce_of_the_file[8:]
                                                sda10=Equal_info_between_of_the_cirlce_of_the_file[0:4]
                                                ...
                                                Times_6=Equal_info_between_of_the_cirlce_of_the_file[0:4]
                                                #print(Times_6)
                                                if len(Times_6)!=0:
                                                    T = int(Times_6, 2)
                                                    #print(T)
